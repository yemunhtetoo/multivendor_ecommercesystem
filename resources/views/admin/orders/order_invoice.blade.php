    ...
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
				...
				<?php echo DNS1D::getBarcodeHTML($orderDetails['id'], 'C39'); ?></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td class="thick-line text-right">ကျပ်{{$subTotal}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">ကျပ် 0</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">ကျပ်{{$orderDetails['grand_total']}}
										<br>
