                    ...
                    <tr>
                      ...
                      <td>
                        @if(!empty($product['product_image']))
                          ...
                          @else
                          <img style="width:120px;height:120px" src="{{ asset('front/images/product_images/small/no image.png') }}" alt="">
                        @endif
                      </td>
                      <td>
                      ...
                      <td>
                       ...
                       <a title="Add images" href="{{ url('admin/add-images/'.$product['id']) }}"> <i style="font-size:25px;" class="mdi mdi-library"></i></a>
