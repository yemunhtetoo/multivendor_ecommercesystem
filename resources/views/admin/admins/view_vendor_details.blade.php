                ...
                <div class="card-body">
                  <h4 class="card-title"> Personal Information</h4>
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{ url('admin/images/photos/'.$vendorDetails['image']) }}" width="100" height="100">View Image
                    </div>
                    @endif
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Business Information</h4>
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Shop Website</label>
                    ...
                    <div class="form-group">
                        <label for="vendor_image"> Photo</label>
                        <br>
                            <img src="{{ url('admin/images/proofs/'.$vendorDetails['vendor_business']['address_proof_image']) }}" width="100" height="100">View Image
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" @if(isset($vendorDetails['vendor_business']['shop_name'])) value="{{$vendorDetails['vendor_business']['pan_number']}}" @endif readonly="">
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Commission Information</h4>
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Commission per order item (%)</label>
                      <form method="post" action="{{url('admin/update-vendor-commission')}}">@csrf
                        ...
                        <input class="form-control" name="commission" @if(isset($vendorDetails['vendor_personal']['commission'])) value="{{$vendorDetails['vendor_personal']['commission']}}" @endif>
                        <br>
