...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                if (resp == "false") {
                    ...
                    $("#check_password").html("<font color='blue'>Current Password is Correct!</font>");
                }
            }, error: function () {
                alert('Error');
            }
    ...
    //Product Attributes Add/Remove Attributes
    var maxField = 10; //Input fields increment limitation
    var addButton = $('.add_button'); //Add button selector
    var wrapper = $('.field_wrapper'); //Input field wrapper
    var fieldHTML = '<div><div style="height:10px;"></div><input type="text" name="size[]" placeholder="Size" style="width: 120px;" />&nbsp;<input type="text" name="sku[]" placeholder="SKU" style="width: 120px;" required="" />&nbsp;<input type="text" name="price[]" placeholder="Price" style="width: 120px;" required="" />&nbsp;<input type="text" name="stock[]" placeholder="Stock" style="width: 120px;" required="" />&nbsp;<a href="javascript:void(0);" class="remove_button">Remove</a></div>'; //New input field html 
